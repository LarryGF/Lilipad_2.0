...
'''determinar el tipo de error,esto se podria mejorar,incluyendo un diccionario con cada tipo de error,para no tener tantos if,solo que no se encontro
	una relacion donde estuvieran todas las posibles respuestas del servidor con su significado'''
