...
mb = ['Incoming network traffic on $1', 'Outgoing network traffic on $1',
      'RAM-used', 'Used disk space on $1']
    ...
    for row in dic.keys():
        ...
        if dic[row]['service'] == servicio:
            ...
            for item_name in item_names:
                ...
                Index[item_name] = {
                    'Asignacion': asignacion[item_name], 'Avg_avg': avg_avg, 'Percentil_max': ans_max}
